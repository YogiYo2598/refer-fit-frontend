...
import { getOTP, verifyOTP, loginUser, getUserAfterLogin } from "../services/authApi";
import OTPWidget from "./OTMWidget";
...
export default function LoginPage() {
    ...
    const widgetId = "35667a705579363832363233";
    const tokenAuth = "456251TM7QdBi8x9685d7bdcP1";
    ...
    const handleSendOTP = async () => {
        ...
        try {
            ...
            // window.alert("Failed to send OTP! Please try again after sometime")
            setLoader(false);
                        ...
                        {otpVerify && (
                            <div className="space-y-1">
                                ...
                                <div className="text-right">
                                    <button type="button" className="text-sm text-blue-600 hover:underline">Resend OTP</button>
                                </div>
                            </div>
                        )}
