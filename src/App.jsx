...
//       {/* Header */}
//       <header className="w-full flex items-center justify-between p-4 border-b shadow-sm">
//         <div className="w-1/3" />
//         <div className="w-1/3 flex items-center justify-center space-x-2">
//           <img src="/logos/refer_fit.png" alt="Refer Fit Logo" className="h-10 w-auto" />
//           <h1 className="text-2xl font-bold text-blue-600">REFER FIT</h1>
//         </div>
...
//           <p className="text-base">With an employee referral, you're more likely to get a callback from HR</p>
//         </div>
//       </section>

//       {/* Main content */}
//       <main className="flex-grow flex flex-col items-center px-4 mt-4 space-y-8">
//         <button className="w-full max-w-sm bg-blue-100 text-blue-800 text-xl font-semibold py-4 rounded-xl shadow hover:bg-blue-200 transition">
//           GET REFERRED
//         </button>
//         <button className="w-full max-w-sm bg-green-100 text-green-800 text-xl font-semibold py-4 rounded-xl shadow hover:bg-green-200 transition">
//           BECOME A REFERRER
//         </button>
//       </main>
...
//         <h2 className="text-center text-xl font-semibold text-gray-700 mb-6">Get Referrals at Top Companies</h2>
